...
* 정규화(normalization)는 데이터를 0에서 1 범위로 변환하는 것이고 표준화(standardization)는 평균은 0 표준편차는 1이 되도록 변환하는 것입니다.
...
* 종합적으로 제가 가지고 있는 (도메인)에 대한 관심과 경험을 통해 쌓은 (직무에서 하는일) 역량을 발휘해 (회사명)과 함께 발전할 수 있다는 생각을 하여 지원하게 되었습니다.
#### 장단점
...
#### 도메인_AI솔루션
* 지원동기 (도메인 관련 경험)
    * LLM을 이용해 사이드 프로젝트로 자동화 블로그를 운영하고 있습니다. 현재 하루 방문자가 6천명 정도 되는데 알고리즘을 계속 개선하기 위해 최신 기술에 관심을 가지고 있습니다. 그래서 관련된 학회나 세미나가 있으면 챙겨보는 편인데 2024 SK AI 서밋에서 올거나이즈라는 회사의 RAG 관련 발표를 본 적이 있습니다. 그때 인상깊었던 것이 테이블 형태의 문서를 읽기 위해 Vision 기술을 복합적으로 사용한다는 점입니다. 그리고 이번 구직 활동에서 ㅇㅇㅇ의 잡디스크립션을 보고 동일한 문제를 해결하고자 한다는 점을 파악했고 제 역량을 발휘할 수 있다고 생각해 지원하게 되었습니다. (+그리고 조사를 더 해보니 제조공장 프로젝트를 추가로 진행한다고 들었는데 그쪽은 동일한 경험을 가지고 있고 제 전문분야이기 때문에 제 역량을 발휘할 수 있다고 생각했습니다.)
* 회사관심도
    * (회사 어떻게 아는지)
        * AI솔루션 분야에서 생성형AI를 잘 활용하는 혁신적인 회사로 알고 있습니다. 대표적인 서비스로 GenOS를 미래에셋에 공급한 것으로 알고 있습니다. 또한 신발관련 제조공장 프로젝트를 진행하는 것으로 알고 있습니다. 그리고 지원동기 같은 경우에는 (지원동기 전체)
    * (역량 적용)
        * Vision 모델 설계와 도메인 지식 활용 역량을 바탕으로 F1 score가 높고 안정적인 모델을 설계하여 제조공장 프로젝트에 활용하겠습니다. 제조공장에 들어가는 모델은 생산량과 직결되기 때문에 안정적인 퍼포먼스가 나와야하고 Vision 모델 설계와 도메인 지식 활용이 필수적입니다. 저는 애플워치 검사 자동화를 통해서 동일한 업무를 해본 경험이 있습니다. 저는 고객사의 입장에 있어봤기 때문에 상대 고객사가 당장 원하는게 뭐고 어떤 방향으로 모델을 만들고자 하는지 남들보다 더 잘 이해할 수 있다고 생각합니다.
    * (입사 시 희망)
        * 제조공장 프로젝트에서 Vision 모델 설계를 하고 싶습니다. 제조공장에 들어가는 모델은 생산량과 직결되기 때문에 안정적인 퍼포먼스가 나와야하고 Vision 모델 설계와 도메인 지식 활용이 필수적입니다. 저는 애플워치 검사 자동화를 통해서 동일한 업무를 해본 경험이 있습니다. 저는 고객사의 입장에 있어봤기 때문에 상대 고객사가 당장 원하는게 뭐고 어떤 방향으로 모델을 만들고자 하는지 남들보다 더 잘 이해할 수 있다고 생각합니다.
    * (입사 후 포부)
        * 먼저 새로 들어온 구성원으로서 업무를 적극적으로 배우겠습니다. 뚜렷한 목표를 가지고 Vision 모델 설계 방법을 이해하겠습니다. 더 나아가 현재보다 더 높은 수준의 AI 모델링 능력을 위해 꾸준히 최신 논문과 알고리즘을 공부하겠습니다. 최종적으로 Vision 모델 설계 업무에서 ㅇㅇㅇ에 큰 힘이 되도록 노력하겠습니다. Vision 모델 설계와 도메인 지식 활용 역량을 최대한 발휘하여 정량적인 성과를 이끌어내도록 하겠습니다.
    * (마지막 한마디)
        * ㅇㅇㅇ과 함께 아디다스의 스피드 팩토리와 각종 명품 브랜드의 공장까지 모두 AI 솔루션을 적용하고 싶습니다. robust한 모델을 만들어 세계적인 자동화 팩토리 AI 알고리즘으로 혁신에 기여하고 싶습니다.
#### 장단점_DS
* (장단점)
