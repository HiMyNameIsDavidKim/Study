...
#### 왜 박사를 하지 않았는가
* 학계 연구도 좋지만 산업계 연구가 저에게 더 적합하다고 생각합니다. 박사를 하면 조금 더 커뮤니티에 보편적인 공헌을 하는 연구를 하고 회사 연구소에서는 소비자들에게 포커스된 연구를 한다고 생각합니다. 저는 눈에 보이는 실제 서비스를 연구하는 것을 선호합니다. 즉각적인 반응과 경제적인 성과로 이어지는 점 때문입니다.
