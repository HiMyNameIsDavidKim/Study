...
* `특정 제품종류와 광고매체의 조합`에서 `신규고객수와 광고투자비의 상관관계`를 발견했다.
<br>

### 3. 상관계수 분석
* ![](https://github.com/user-attachments/assets/d0621880-4b58-4ee4-bcac-036f5cdac1d9)
* 제품종류와 광고매체의 상관관계를 정량적으로 나타내 시각화한다.
* 대분류 기준 `정량적인 값이 0.64 이상인 조합을 다수 발견`했다.
...
* 중분류 기준에서도 `정량적인 값이 0.64 이상인 조합을 다수 발견`했다.
* `광고 최적화로 효율적인 고객 유입을 유도`할 수 있다.
<br>
...
### 1. 성과지표 별 광고 전략
* ![](https://github.com/user-attachments/assets/81cbc989-2845-4b85-a384-27b9fec4e491)
